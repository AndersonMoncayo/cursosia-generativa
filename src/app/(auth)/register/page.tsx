...
export default function Register() {
	...
	const handleRegister = async (e: React.FormEvent) => {
		...
		try {
			// INFO: En Supabase Dashboard -> Authentication -> Providers -> Email
			// IMPORTANTE DESACTIVAR "Confirm email" para no requerir verificacion
			...
			if (
				...
				toast.error("Este correo ya tiene una cuenta. Ve a Iniciar Sesión.");
				setLoading(false);
				return;
			}
					...
					<div className="bg-white border-4 border-black retro-shadow-lg flex flex-col">
						...
						<div className="p-8">
							<div className="text-center mb-8">
								<h1 className="sr-only">Crear Cuenta en CursosIA Generativa</h1>
							...
							<div className="flex mb-8 border-b-2 border-black">
								...
								<button className="flex-1 py-3 font-black uppercase text-sm border-b-4 border-primary text-black transition-colors">
									Create
								</button>
							</div>
