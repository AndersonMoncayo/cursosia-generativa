				...
				<div className="w-full max-w-md">
					<div className="bg-white border-4 border-black retro-shadow-lg overflow-hidden flex flex-col">
						...
						<div className="p-8 text-center text-black">
							<div className="text-7xl mb-4 text-primary material-symbols-outlined">
								mark_email_read
							</div>
							...
							<p className="text-slate-600 font-bold mb-6">
								Te hemos enviado un enlace de verificación. Ábrelo para activar
								tu cuenta.
							</p>
							<div className="bg-primary/10 border-2 border-primary p-4 mb-6">
								<p className="text-black font-bold text-sm uppercase">
									ATENCION: Recuerda revisar tu carpeta de spam si no lo
									encuentras.
								</p>
							</div>
							<Link
								href="/login"
								className="block w-full bg-primary border-4 border-black py-4 font-black uppercase tracking-widest retro-shadow retro-btn text-black hover:bg-white transition-colors"
							>
								Volver al Login
							</Link>
						</div>
