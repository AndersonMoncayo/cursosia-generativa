        ...
        <div className="w-full max-w-md">
          <div className="bg-white border-4 border-black flex flex-col retro-shadow-lg relative z-10">
            <div className="os-bar px-4 py-2 flex items-center justify-between">
              ...
              <span className="text-[10px] font-bold text-white uppercase tracking-widest">PWD_RESET.exe</span>
            </div>
            
            <div className="p-8 text-black">
              <h1 className="text-3xl font-black uppercase mb-2 leading-tight">Reiniciar Sesión</h1>
              <p className="text-slate-600 font-bold mb-6 text-sm uppercase">Ingresa tu email para recibir un enlace de recuperación.</p>
              
              {!sent ? (
                <form onSubmit={handleReset} className="space-y-6">
                  <div>
                    <label className="block text-xs font-black uppercase mb-2">Email_Asociado</label>
                    <input
                      type="email"
                      value={email}
                ...
                <div className="bg-primary/20 border-2 border-primary p-4 text-center">
                  ...
                  <h3 className="font-black uppercase mb-1">Enlace Transmitido</h3>
                  <p className="text-xs font-bold uppercase text-slate-800">Revisa tu bandeja de entrada (y spam).</p>
                </div>
              )}
              
              <div className="mt-8 pt-6 border-t-2 border-slate-200 text-center">
                <Link href="/login" className="text-sm font-bold uppercase hover:text-primary transition-colors hover:underline">
