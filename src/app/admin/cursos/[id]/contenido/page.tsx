  ...
  return (
    <div className="space-y-10 pb-20">
      <div className="flex justify-between items-end border-b-8 border-primary pb-6">
        <div>
          <Link href="/admin/cursos" className="inline-flex items-center gap-2 text-primary hover:text-white font-bold text-sm tracking-widest uppercase mb-4 transition-colors">
