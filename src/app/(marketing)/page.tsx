...
export const metadata: Metadata = {
	...
	description:
		"Cursos practicos de IA Generativa en espanol. Aprende ChatGPT, Claude, N8N y automatizaciones reales. Desde cero hasta produccion.",
	openGraph: {
		title: "CursosIA Generativa — Domina la IA",
		description:
			"Cursos estructurados 100% practicos. Aprende ChatGPT, N8N, Claude.",
		...
		<div className="bg-background-dark min-h-screen font-display text-slate-100 grid-pattern">
			...
			<section className="relative px-6 py-20 md:py-32 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
				...
				<h1 className="text-6xl md:text-8xl lg:text-9xl font-black text-white uppercase leading-[0.9] tracking-tighter mb-8 drop-shadow-md">
					Domina La <br />
					<span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-emerald-400 border-b-8 border-primary md:inline-block">
						IA Generativa
					</span>
				</h1>

				<p className="text-lg md:text-xl text-slate-400 font-bold max-w-2xl mb-12 uppercase leading-relaxed">
					Cursos estructurados, 100% prácticos y directos al grano. Aprende
					ChatGPT, n8n, Claude y automatizaciones reales.
				</p>

				<div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
					<Link
						href="/cursos"
						className="bg-primary text-black font-black px-10 py-5 text-xl uppercase border-4 border-black retro-shadow-lg retro-btn flex items-center justify-center gap-3 w-full sm:w-auto hover:bg-white transition-colors"
					>
						Explorar Cursos <Rocket className="w-6 h-6" />
					</Link>
					<Link
						href="/precios"
						className="bg-white text-black font-black px-10 py-5 text-xl uppercase border-4 border-black retro-shadow-lg retro-btn flex items-center justify-center gap-3 w-full sm:w-auto hover:bg-primary transition-colors"
					>
			...
			<section className="bg-slate-100 border-y-8 border-black py-24">
				<div className="max-w-7xl mx-auto px-6">
					<div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
						...
						<Link
							href="/cursos"
							className="font-black text-black uppercase border-b-4 border-primary hover:text-primary transition-colors text-lg"
						>
							Ver Todos →
						</Link>
					</div>
