	...
	return (
		<div className="bg-background-dark min-h-screen font-display text-slate-100">
			...
			<main className="max-w-7xl mx-auto px-6 py-20">
				<div className="mb-16">
					<span className="bg-primary text-black px-4 py-1 font-black uppercase text-sm border-2 border-black mb-4 inline-block">
						BLOG_FEED.RSS
					</span>
								...
								<div className="bg-white border-4 border-black retro-shadow-lg flex flex-col h-full hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all group">
									<div className="os-bar px-3 py-1 flex items-center justify-between">
										...
										<span className="text-[10px] font-bold text-white uppercase tracking-widest">
											POST_{String(i + 1).padStart(3, "0")}.md
										</span>
									</div>
									<div className="h-48 bg-primary border-b-4 border-black relative overflow-hidden flex items-center justify-center">
										{post.cover_url ? (
											...
											<span className="material-symbols-outlined text-5xl text-black opacity-50">
												article
											</span>
										)}
										{post.category && (
									...
									<div className="p-6 flex flex-col flex-grow text-black">
										...
										<p className="text-slate-600 text-sm font-bold flex-grow line-clamp-3">
											{post.excerpt}
										</p>
										<span className="mt-6 text-primary border-b-2 border-primary font-black w-max uppercase hover:text-black hover:border-black transition-colors">
											Leer Artículo →
										</span>
									</div>
								</div>
