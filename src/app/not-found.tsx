			...
			<div className="flex-1 flex items-center justify-center px-6 py-20">
				<div className="text-center">
					<div className="inline-block bg-white border-4 border-black retro-shadow-lg p-12 mb-12 transform -rotate-2">
						...
						<p className="text-black font-black uppercase text-2xl tracking-tighter">
					...
					<div className="flex flex-col sm:flex-row justify-center gap-4">
						<Link
							href="/"
							className="bg-primary text-black font-black px-8 py-4 border-4 border-black retro-shadow retro-btn uppercase text-lg hover:bg-white transition-colors"
						>
							← Volver al Origen
						</Link>
						<Link
							href="/cursos"
							className="bg-white text-black font-black px-8 py-4 border-4 border-black retro-shadow retro-btn uppercase text-lg hover:bg-primary transition-colors"
						>
							Explorar Catálogo
						</Link>
					</div>
