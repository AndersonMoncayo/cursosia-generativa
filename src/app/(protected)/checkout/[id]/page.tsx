	...
	if (loading) {
		return (
			<div className="min-h-screen bg-background-dark flex items-center justify-center font-display">
				<span className="text-white font-black text-2xl uppercase animate-pulse">
					Cargando Checkout...
				</span>
			</div>
		);
			...
			<main className="max-w-5xl mx-auto px-6 py-12 md:py-20">
				<div className="mb-8">
					<Link
						...
						className="text-primary font-black text-sm uppercase hover:underline"
					>
						← Volver al curso
					</Link>
				</div>
					...
					<div className="flex-1">
						<div className="bg-white border-4 border-black retro-shadow-lg p-8">
							...
							<div className="flex gap-4 mb-6">
								...
								<div>
									<h3 className="font-black uppercase text-lg leading-tight mb-1">
										{course.title}
									</h3>
					...
					<div className="flex-1">
						<div className="bg-white border-4 border-black p-8 retro-shadow-lg">
							<h2 className="text-2xl font-black uppercase mb-6 border-b-4 border-black pb-2 flex items-center gap-2">
								<span className="material-symbols-outlined">lock</span> Datos de
								Pago
							</h2>

							<form onSubmit={handleCheckout} className="space-y-4">
								<div className="bg-slate-100 border-2 border-dashed border-slate-400 p-6 text-center mb-6">
									<span className="material-symbols-outlined text-black text-4xl mb-2">
								...
								<div>
									...
									<input
										type="text"
										required
										className="w-full bg-slate-100 border-2 border-black p-3 font-bold focus:bg-white focus:outline-none focus:border-primary"
								...
								<div className="pt-4">
									<label className="flex items-start gap-3 cursor-pointer">
										<input
											type="checkbox"
											required
											className="w-5 h-5 mt-0.5 border-2 border-black accent-primary"
										/>
										<span className="text-xs font-bold leading-tight uppercase text-slate-600">
											Acepto los términos de servicio, política de privacidad y
											renuncio a mi derecho de retracto ya que es un producto
											digital de entrega inmediata.
										</span>
									</label>
								</div>
