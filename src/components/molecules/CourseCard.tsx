...
export const CourseCard: React.FC<CourseCardProps> = ({ course, progress, isPurchased }) => {
  return (
    <div className={`${course.color || (isPurchased ? 'bg-white' : 'bg-white')} border-4 border-black retro-shadow-lg flex flex-col group hover:-translate-y-2 transition-transform duration-300 relative overflow-hidden`}>
