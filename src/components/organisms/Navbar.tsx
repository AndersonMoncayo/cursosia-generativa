      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            {user ? (
              <Link href="/dashboard" className="bg-primary text-black font-black px-6 py-2 uppercase border-2 border-black retro-shadow retro-btn text-sm">
                Dashboard →
              </Link>
            ) : (
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-background-dark border-b-4 border-black absolute w-full left-0 z-40">
          <div className="px-4 pt-2 pb-6 space-y-2 flex flex-col">
            ...
            {user ? (
              <Link href="/dashboard" className="bg-primary text-black font-black px-4 py-3 uppercase border-2 border-black text-center mt-4 retro-shadow">
                Dashboard
              </Link>
            ) : (
