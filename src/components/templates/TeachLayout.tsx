...
const NAV_ITEMS = [
  { href: '/teach', label: 'MI PANEL', icon: LayoutDashboard },
  { href: '/teach/cursos', label: 'MIS CURSOS', icon: BookOpen },
  { href: '/teach/estudiantes', label: 'ESTUDIANTES', icon: Users },
  { href: '/teach/ingresos', label: 'INGRESOS', icon: DollarSign },
  { href: '/teach/estadisticas', label: 'ESTADÍSTICAS', icon: BarChart2 },
]
    ...
    <div className="h-full flex flex-col bg-black border-r-2 border-[#1acb5b]">
      <div className="p-4 border-b-2 border-[#1acb5b]">
        <div className="flex items-center justify-between">
          <Link href="/teach" className="text-lg font-black uppercase tracking-widest text-[#1acb5b]">
            TEACH.SYS
          </Link>
          {onClose && (
    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white font-[Space_Grotesk,sans-serif] flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-black border-b-2 border-[#1acb5b]">
          ...
          <span className="text-sm font-black uppercase tracking-widest text-[#1acb5b]">TEACH.SYS</span>
          <div className="w-10" />
        </header>
